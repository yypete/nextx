<template>
  <!-- sidebar-menu -->
  <div
    class="sidebar-menu bg-white w-40 h-[70%] py-2 rounded-lg translate-x-20"
  >
    ...
    <router-link to="/decrypt-box" class="menu-item">
      ...
      >
        <div>
          <i class="menu-icon fi fi-rr-display-code pr-2"></i>
          <span class="menu-text">解密</span>
        </div>
        <i class="arrow-icon fi fi-ss-angle-small-right"></i>
      </a>
    </router-link>
    ...
    <router-link to="/math-box" class="menu-item">
      ...
      >
        <div>
          <i class="menu-icon fi fi-rr-chart-pie-alt pr-2"></i>
          <span class="menu-text">数学</span>
        </div>
        <i class="arrow-icon fi fi-ss-angle-small-right"></i>
      </a>
    </router-link>
    <router-link to="/media-box" class="menu-item">
      ...
      >
        <div>
          <i class="menu-icon fi fi-br-tv-retro pr-2"></i>
    ...
    <router-link to="/calendar-box" class="menu-item">
      ...
      >
        <div>
          <i class="menu-icon fi fi-rs-calendar-clock pr-2"></i>
          <span class="menu-text">日期</span>
        </div>
        <i class="arrow-icon fi fi-ss-angle-small-right"></i>
      </a>
    </router-link>
    <router-link to="/other-box" class="menu-item">
      ...
      >
        <div>
          <i class="menu-icon fi fi-rr-bulb pr-2"></i>
